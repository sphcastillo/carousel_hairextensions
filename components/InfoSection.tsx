...
import barbiePink from "/images/barbiePink.jpg";
import pink from "@/public/images/barbiePink.jpg";
const posts = [
  {
    id: 1,
...
export default function InfoSection() {
  return (
    // <div className=" py-24 sm:py-32 bg-gradient-to-b from-[#fec2d6] to-[#fdd9e5]">
    <div 
      className=" py-24 sm:py-32 bg-cover bg-center "
      style={{ backgroundImage: `url(${barbiePink.src})` }}
    >
            ...
            >
              ...
              <div className="max-w-xl">
                ...
                <div className="group relative">
                  <h3 className="mt-3 text-lg font-semibold leading-6 text-gray-500 group-hover:text-gray-600">
                    <a href={post.href}>
