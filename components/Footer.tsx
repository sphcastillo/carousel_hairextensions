...
const navigation = [
  ...
  // },
  {
    ...
    icon: (props: any) => <FaTiktok className="h-5 w-5 mt-[1px]" />,
  },
  {
    name: "Facebook",
...
export default function Footer() {
  return (
    <footer
      className={`${raleway_regular.className} bg-[#ffC0CB]`}
      style={{
    ...
    >
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        <div className="flex justify-center gap-x-6 md:order-2">
          {navigation.map((item, index) => (
            <Link
              ...
              className="text-black hover:text-[#77c4ca] cursor-pointer"
            >
        ...
        <p className="mt-8 text-center text-sm/6 text-black md:order-1 md:mt-0">
          &copy; 2025 Carousel Hair Extensions, Inc. All rights reserved.
        </p>
        <div className="flex justify-center items-center">
          <p className="text-xs leading-5 text-black pt-1">
            Website designed &
            <Link
